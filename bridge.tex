...
\usepackage{etoolbox}
\usepackage[headsep=0.1cm,margin=0.1cm,tmargin=0.6cm,outer=0.5cm,inner=0.2cm]{geometry}	%%% attention l'entete se trouve "dans" la marge
...
\fancyhead[CO]{LIPIETZ Hélène 792 988 - 4♠ /  ROUQUETTE Rémi 792 996 - 4♠}
	...
	Landik et texas (2♣ promet 2 majeures si non fitté ds mineure, 1 majeure si fitté) \newline
 	...
 	\g{Réveil >1 SA} \newline
	2♣ à 2♠ ; X 2 maj. 4ème ou + [réponses naturelles]
