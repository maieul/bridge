% Tu ne touche à rien de ce qu'il y a en dessous
...
% A partir d'ici tu peux toucher
	...
	\textbf{Principes de base}\\ % Un \\ indique un changement de ligne (≠ du changement de ¶)
	♥~♠  5ième SMI 				\\
	Meilleure ♣~♦  ; SMI (sans 4C/P.),>10DH\\
	\g{Ouvertures fortes}\\		 % \g{texte en gras}
	...
	\begin{tabular}{p{0.48\textwidth}|p{0.48\textwidth}}		% Pour avoir deux colonnes (en théorie tu n'a pas à touché)
	 \textbf{Interventions sur 1 couleur} & \textbf{Défausse} \\ % Le & indique le changement de colonne, le // le changement de ligne
